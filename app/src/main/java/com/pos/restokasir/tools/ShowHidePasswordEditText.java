...
public class ShowHidePasswordEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.ic_visibility_off);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.ic_visibility);
            ...
            visibilityIndicatorShow = R.drawable.ic_visibility_off;
            visibilityIndicatorHide = R.drawable.ic_visibility;
        }

        final float scale = getResources().getDisplayMetrics().density;
        int padding_5dp = (int) (5 * scale + 0.5f);
        setCompoundDrawablePadding(padding_5dp);
